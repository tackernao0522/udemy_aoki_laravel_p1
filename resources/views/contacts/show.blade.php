                                ...
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            ...
                                            <div class="w-full rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-48 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out">{!! nl2br(e($contact->contact)) !!}</div>
                                        </div>
                                    </div>
                                    ...
                                    <form method="POST"
                                        ...
                                        id="delete_{{ $contact->id }}" style="margin-left: auto;">
                                        @csrf
                                        <div class="p-2 w-full">
