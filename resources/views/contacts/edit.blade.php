                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <select name="age">
                                                    ...
                                                    <option value="2"
                                                        {{ old('age', $contact->age) == 2 ? 'selected' : '' }}>20歳〜29歳
                                                    </option>
                                                    <option value="3"
                                                        {{ old('age', $contact->age) == 3 ? 'selected' : '' }}>30歳〜39歳
                                                    </option>
                                                    <option value="4"
                                                        {{ old('age', $contact->age) == 4 ? 'selected' : '' }}>40歳〜49歳
                                                    </option>
                                                    <option value="5"
                                                        {{ old('age', $contact->age) == 5 ? 'selected' : '' }}>50歳〜59歳
                                                    </option>
                                                    <option value="6"
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <textarea id="contact" name="contact"
                                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out">{!! nl2br(e(old('contact', $contact->contact))) !!}</textarea>
                                            </div>
                                        </div>
